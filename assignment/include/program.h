...
// Forward definitions
extern void progdef(struct symbol *name, struct symlist *syms,
                    struct nodelist *stmts);
extern struct maplist **mergeprograms(struct symbol **progrefs,
                                      struct symlist **export,
                                      struct nodelist **params, int compartnum,
                                      int size);
